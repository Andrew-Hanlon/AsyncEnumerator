...
{
    [TestClass]
    public class AsyncParallelEnumeratorTests
    {
        [TestMethod]
        ...
        private static async AsyncParallelEnumerator<int> Test1()
        {
            var iter = await AsyncParallelEnumerator<int>.Capture();
        ...
        private static async AsyncParallelEnumerator<int> Test2()
        {
            var iter = await AsyncParallelEnumerator<int>.Capture();
